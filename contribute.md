...
Each GTFO binary is defined in a file in the [`_wadcoms/`] folder named as `<binary name>.md`, such file consists only of a [YAML] front matter which describes the binary and its functions.
...
Where `FUNCTION` is one of the values described in the [`_data/filters.yml`] file.
...
Pull requests adding new functions in [`_data/filters.yml`] are allowed and subjected to project maintainers vetting.

[YAML]: http://yaml.org/
[`_wadcoms/`]: https://github.com/GTFOBins/GTFOBins.github.io/tree/master/_gtfobins
[`_data/filters.yml`]: https://github.com/GTFOBins/GTFOBins.github.io/blob/master/_data/filters.yml
